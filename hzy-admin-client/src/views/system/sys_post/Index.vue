...
async function findList() {
  state.loading = true;
  const result = await SysPostService.findList(state.page, state.size, state.search.vm);
  state.loading = false;
...
function exportExcel() {
  SysPostService.exportExcel(state.search.vm);
}
</script>
  ...
  <PageContainer>
    ...
    >
      ...
      <template #table-col>
        ...
        <a-table-column title="岗位编码" data-index="code" />
