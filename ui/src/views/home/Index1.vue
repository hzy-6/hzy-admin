<template>
  <div>
    <a-card style="width: 100%; border: 0" class="mb-20">
      <a-row>
        <a-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8" class="mt-20">
          <a-row type="flex">
            ...
            <a-col :span="16" :order="2">
              ...
              <div class="fs-20">
                <a target="_black" href="https://next.antdv.com/components/icon-cn" class="text-danger">组件官网：Ant Design Vue 2.0</a>
              </div>
            </a-col>
          </a-row>
        </a-col>
          ...
          <a-row :gutter="20" class="mt-20">
            ...
            <a-col :span="8" class="text-center">
              <a-statistic title="Fork" :value="167">
                <template #suffix>
                  <AppIcons name="BranchesOutlined" />
                </template>
              </a-statistic>
            </a-col>
          </a-row>
      ...
      <a-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
        <a-card hoverable>
          <a-timeline mode="alternate">
            ...
            <a-timeline-item>
              <template #dot>
                <AppIcons name="ClockCircleOutlined" style="font-size: 16px" />
              </template>
    ...
    <a-row :gutter="20">
      <a-col :xs="24" :sm="8" :md="8" :lg="6" :xl="6" class="mt-20" v-for="(item, index) in 8" :key="index">
        <a-card hoverable>
          ...
          <template #actions>
            <AppIcons name="setting-outlined" key="setting" />
            <AppIcons name="edit-outlined" key="edit" />
            <AppIcons name="ellipsis-outlined" key="ellipsis" />
          </template>
