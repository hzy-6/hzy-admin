<template>
  <a-modal v-model:visible="visible" title="编辑" centered @ok="visible = false" :width="800">
    ...
    <a-spin :spinning="saveLoading">
      <a-form ref="formRef" layout="vertical" :model="vm" :rules="rules">
        <a-row :gutter="[15, 15]">
          <a-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12">
            <a-form-item label="任务名称" ref="name" name="name">
              <a-input v-model:value="vm.name" placeholder="请输入" />
            </a-form-item>
          </a-col>
          <a-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12">
            <a-form-item label="分组" ref="groupName" name="groupName">
              <a-input v-model:value="vm.groupName" placeholder="请输入" />
            </a-form-item>
          </a-col>
          <a-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12">
            <a-form-item ref="cron" name="cron">
              ...
              <!-- <a-input v-model:value="vm.cron" placeholder="请输入" /> -->
              <GenerateCron v-model:value="vm.cron" />
            </a-form-item>
          </a-col>
          <a-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12">
            <a-form-item label="请求方式" ref="requsetMode" name="requsetMode">
              <a-select v-model:value="vm.requsetMode">
          ...
          <a-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12">
            <a-form-item label="HeaderToken" ref="headerToken" name="headerToken">
              <a-input v-model:value="vm.headerToken" placeholder="请输入" />
            </a-form-item>
          </a-col>
          <a-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
            <a-form-item label="ApiUrl" ref="apiUrl" name="apiUrl">
              <a-textarea ref v-model:value="vm.apiUrl" placeholder="请输入" :rows="4" />
            </a-form-item>
          </a-col>
          <a-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
            <a-form-item label="描述">
              <a-textarea v-model:value="vm.remark" placeholder="请输入" :rows="4" />
            </a-form-item>
          </a-col>
        </a-row>
      </a-form>
