<template>
  <a-modal v-model:visible="visible" title="数据权限设置" centered @ok="visible = false" :width="400" :bodyStyle="{ overflowY: 'auto', height: 'calc(100vh - 300px)' }">
    ...
    <a-spin :spinning="loading">
      ...
      <a-radio-group v-model:value="form.sysDataAuthority.permissionType">
      ...
      <div v-if="form.sysDataAuthority.permissionType === 1">
        ...
        <div style="max-height: 280px; overflow-y: auto">
          <a-tree v-model:expandedKeys="tree.expandedKeys" v-model:checkedKeys="tree.checkedKeys" checkable :tree-data="tree.data">
