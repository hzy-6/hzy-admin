        ...
        >
          ...
          <vxe-column field="id" title="操作" width="300">
            <template #default="{ row }">
              ...
              <a-divider type="vertical" />
              <a href="javascript:void(0)" @click="openRoleFunctionWindow(row.id)">功能权限</a>
              <a-divider type="vertical" />
              <a href="javascript:void(0)" @click="openRoleDataAuthorityWindow(row.id)">数据权限</a>
            </template>
          </vxe-column>
        </vxe-table>
        <vxe-pager
...
export default defineComponent({
  name: "system_role",
  components: { AppIcons, Info, RoleFunction, RoleDataAuthority },
  setup() {
