  ...
  <a-modal v-model:visible="visible" :title="vm.id ? '编辑' : '新建'" centered @ok="visible = false" width="1000px" :bodyStyle="{ overflowY: 'auto', height: 'calc(100vh - 150px)' }">
    ...
    <a-spin :spinning="saveLoading">
      <a-tabs v-model:activeKey="activeKey">
        <a-tab-pane key="1" tab="基础数据设置">
          <a-form layout="vertical" :model="vm.form">
            <a-row :gutter="[15, 15]">
              ...
              <a-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" v-if="vm.form.type == 2">
              ...
              <a-col :xs="24" v-if="vm.form.type == 2">
                <a-row style="width: 100%">
                  ...
                  <a-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12">
                    <a-form-item label="是否缓存组件">
                      <a-radio-group v-model:value="vm.form.keepAlive">
        ...
        <!-- 选项卡二 -->
        <a-tab-pane key="2" tab="功能模块设置" force-render v-if="vm.form.type == 2">
          <a-table :data-source="vm.menuFunctionList" size="small" :pagination="false">
