namespace HZY.Shared.ApplicationServices.LowCodes;

/// <summary>
/// 数据库表服务
/// </summary>
public class DatabaseTableService : ApplicationService
{
    ...
    /// </summary>
    /// <returns></returns>
    public List<DbTableInfo> GetAllTableInfos() => _freeSql.DbFirst.GetTablesByDatabase();
    ...
    /// </summary>
    /// <returns></returns>
    public string GetDatabaseName() => _lowCodeTableRepository.Context.Database.GetDbConnection().Database;
