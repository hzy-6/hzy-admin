...
namespace HZY.Core.Razor.Services.Impl
{
    /// <summary>
    /// razor cshtml 模板渲染
    /// </summary>
    public class RazorViewRenderImpl : IRazorViewRender
    {
        private readonly IRazorViewEngine _razorViewEngine;
        private readonly ITempDataProvider _tempDataProvider;
        private readonly IServiceProvider _serviceProvider;

        public RazorViewRenderImpl(IRazorViewEngine razorViewEngine, ITempDataProvider tempDataProvider,
