...
class SysDataAuthorityService {

    private controllerName: string = "admin/SysDataAuthority";
     ...
     * @returns 
     */
    getDataAuthorityByRoleId(roleId: string): Promise<ApiResult<any>> {
        return Http.get(`${this.controllerName}/getDataAuthorityByRoleId/${roleId}`);
    }
}

export default new SysDataAuthorityService()