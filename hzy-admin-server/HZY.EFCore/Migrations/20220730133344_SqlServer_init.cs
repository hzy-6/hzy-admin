        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Remark = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProjectRootPath = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    IndexVuePath = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    InfoVuePath = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ServiceJsPath = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0a8bdb18-758a-4798-9ffc-e7031dcbf262"), "hzy-admin-server/HZY.Controllers.Admin/App/", new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "岗位", "SysPost", "hzy-admin-client/src/views/app/", "hzy-admin-client/src/views/app/", false, new DateTime(2022, 7, 30, 20, 42, 3, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/App/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/app/", "hzy-admin-server/HZY.Services.Admin/App/", "sys_post", "TABLE" },
                    { new Guid("18fbb18e-cb29-45d8-a5f3-c0121c57680a"), "hzy-admin-server/HZY.Controllers.Admin/App/", new DateTime(2022, 7, 29, 0, 0, 0, 0, DateTimeKind.Unspecified), "", "FlowApprovalStepHistory", "hzy-admin-client/src/views/app/", "hzy-admin-client/src/views/app/", false, new DateTime(2022, 7, 30, 20, 42, 27, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/App/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/app/", "hzy-admin-server/HZY.Services.Admin/App/", "flow_approval_step_history", "TABLE" },
                    { new Guid("1a8df018-79f8-4e26-b4eb-4b735aae7275"), "hzy-admin-server/HZY.Controllers.Admin/App/", new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "审批流", "Flow", "hzy-admin-client/src/views/app/", "hzy-admin-client/src/views/app/", false, new DateTime(2022, 7, 30, 20, 42, 3, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/App/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/app/", "hzy-admin-server/HZY.Services.Admin/App/", "flow", "TABLE" },
                    { new Guid("2ae9e532-7d9a-474b-b629-50a39945c44d"), "hzy-admin-server/HZY.Controllers.Admin/App/", new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "菜单功能", "SysMenuFunction", "hzy-admin-client/src/views/app/", "hzy-admin-client/src/views/app/", false, new DateTime(2022, 7, 30, 20, 42, 3, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/App/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/app/", "hzy-admin-server/HZY.Services.Admin/App/", "sys_menu_function", "TABLE" },
                    { new Guid("3da5d264-2e8d-460c-a10c-ff9a6bb57a60"), "hzy-admin-server/HZY.Controllers.Admin/App/", new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "用户与角色", "SysUserRole", "hzy-admin-client/src/views/app/", "hzy-admin-client/src/views/app/", false, new DateTime(2022, 7, 30, 20, 42, 27, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/App/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/app/", "hzy-admin-server/HZY.Services.Admin/App/", "sys_user_role", "TABLE" },
                    { new Guid("524e71b4-cbf7-4248-8b29-3f99b43f2eb2"), "hzy-admin-server/HZY.Controllers.Admin/App/", new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "自定义数据权限", "SysDataAuthorityCustom", "hzy-admin-client/src/views/app/", "hzy-admin-client/src/views/app/", false, new DateTime(2022, 7, 30, 20, 42, 3, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/App/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/app/", "hzy-admin-server/HZY.Services.Admin/App/", "sys_data_authority_custom", "TABLE" },
                    { new Guid("60cceba1-28bf-4d1d-b603-4edf95d512b8"), "hzy-admin-server/HZY.Controllers.Admin/App/", new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "操作日志", "SysOperationLog", "hzy-admin-client/src/views/app/", "hzy-admin-client/src/views/app/", false, new DateTime(2022, 7, 30, 20, 42, 3, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/App/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/app/", "hzy-admin-server/HZY.Services.Admin/App/", "sys_operation_log", "TABLE" },
                    { new Guid("6323638b-a45f-4a76-886e-69a9e9be0901"), "hzy-admin-server/HZY.Controllers.Admin/App/", new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "用户", "SysUser", "hzy-admin-client/src/views/app/", "hzy-admin-client/src/views/app/", false, new DateTime(2022, 7, 30, 20, 42, 3, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/App/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/app/", "hzy-admin-server/HZY.Services.Admin/App/", "sys_user", "TABLE" },
                    { new Guid("651bb982-1130-4e1c-9070-36b90dcf2324"), "hzy-admin-server/HZY.Controllers.Admin/App/", new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "工作流审批步骤配置", "FlowApprovalStep", "hzy-admin-client/src/views/app/", "hzy-admin-client/src/views/app/", false, new DateTime(2022, 7, 29, 21, 59, 11, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/App/", null, null, null, "hzy-admin-client/src/service/app/", "hzy-admin-server/HZY.Services.Admin/App/", "flow_approval_step", null },
                    { new Guid("69b24f04-0ed3-45fc-91d9-0dc929175a57"), "hzy-admin-server/HZY.Controllers.Admin/App/", new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "用户与岗位", "SysUserPost", "hzy-admin-client/src/views/app/", "hzy-admin-client/src/views/app/", false, new DateTime(2022, 7, 30, 20, 42, 27, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/App/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/app/", "hzy-admin-server/HZY.Services.Admin/App/", "sys_user_post", "TABLE" },
                    { new Guid("69edd8a8-1d24-478c-a909-b82039edcec0"), "hzy-admin-server/HZY.Controllers.Admin/App/", new DateTime(2022, 5, 23, 0, 0, 0, 0, DateTimeKind.Unspecified), "低代码检索表", "LowCodeSearch", "hzy-admin-client/src/views/app/", "hzy-admin-client/src/views/app/", false, new DateTime(2022, 7, 30, 20, 42, 27, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/App/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/app/", "hzy-admin-server/HZY.Services.Admin/App/", "low_code_search", "TABLE" },
                    { new Guid("6ba9805c-916e-4d2c-99d0-216fcbc361cc"), "hzy-admin-server/HZY.Controllers.Admin/App/", new DateTime(2022, 5, 23, 0, 0, 0, 0, DateTimeKind.Unspecified), "低代码表", "LowCodeTable", "hzy-admin-client/src/views/app/", "hzy-admin-client/src/views/app/", false, new DateTime(2022, 7, 30, 20, 42, 27, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/App/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/app/", "hzy-admin-server/HZY.Services.Admin/App/", "low_code_table", "TABLE" },
                    { new Guid("6fabc67a-8b48-49a6-8ba1-c8a32c499d36"), "hzy-admin-server/HZY.Controllers.Admin/App/", new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "功能", "SysFunction", "hzy-admin-client/src/views/app/", "hzy-admin-client/src/views/app/", false, new DateTime(2022, 7, 30, 20, 42, 3, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/App/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/app/", "hzy-admin-server/HZY.Services.Admin/App/", "sys_function", "TABLE" },
                    { new Guid("73c97832-4e7f-4758-86d2-94327971b5fd"), "hzy-admin-server/HZY.Controllers.Admin/App/", new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "会员", "Member", "hzy-admin-client/src/views/app/", "hzy-admin-client/src/views/app/", false, new DateTime(2022, 7, 30, 20, 42, 3, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/App/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/app/", "hzy-admin-server/HZY.Services.Admin/App/", "member", "TABLE" },
                    { new Guid("79fbd4ec-9f4e-45dc-8065-70f2eb422cdf"), "hzy-admin-server/HZY.Controllers.Admin/App/", new DateTime(2022, 5, 23, 0, 0, 0, 0, DateTimeKind.Unspecified), "低代码表信息", "LowCodeTableInfo", "hzy-admin-client/src/views/app/", "hzy-admin-client/src/views/app/", false, new DateTime(2022, 7, 30, 20, 42, 27, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/App/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/app/", "hzy-admin-server/HZY.Services.Admin/App/", "low_code_table_info", "TABLE" },
                    { new Guid("7ad3b915-f0bd-443a-89cd-42d41dd6c554"), "hzy-admin-server/HZY.Controllers.Admin/App/", new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "工作流用户审批步骤", "FlowApprovalStepUser", "hzy-admin-client/src/views/app/", "hzy-admin-client/src/views/app/", false, new DateTime(2022, 7, 29, 21, 59, 11, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/App/", null, null, null, "hzy-admin-client/src/service/app/", "hzy-admin-server/HZY.Services.Admin/App/", "flow_approval_step_user", null },
                    { new Guid("7f94e0db-fc63-40dc-bfe3-18c5aad75975"), "hzy-admin-server/HZY.Controllers.Admin/App/", new DateTime(2022, 7, 29, 0, 0, 0, 0, DateTimeKind.Unspecified), "", "FlowApprovalStepHistoryUser", "hzy-admin-client/src/views/app/", "hzy-admin-client/src/views/app/", false, new DateTime(2022, 7, 30, 20, 42, 27, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/App/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/app/", "hzy-admin-server/HZY.Services.Admin/App/", "flow_approval_step_history_user", "TABLE" },
                    { new Guid("852f53ff-0d00-4c32-aa55-a9c11993751b"), "hzy-admin-server/HZY.Controllers.Admin/App/", new DateTime(2022, 5, 23, 0, 0, 0, 0, DateTimeKind.Unspecified), "低代码列表", "LowCodeList", "hzy-admin-client/src/views/app/", "hzy-admin-client/src/views/app/", false, new DateTime(2022, 7, 30, 20, 42, 27, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/App/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/app/", "hzy-admin-server/HZY.Services.Admin/App/", "low_code_list", "TABLE" },
                    { new Guid("8da38d20-8a09-4e81-8dd8-ed6702aee380"), "hzy-admin-server/HZY.Controllers.Admin/App/", new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "角色菜单功能关联", "SysRoleMenuFunction", "hzy-admin-client/src/views/app/", "hzy-admin-client/src/views/app/", false, new DateTime(2022, 7, 30, 20, 42, 3, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/App/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/app/", "hzy-admin-server/HZY.Services.Admin/App/", "sys_role_menu_function", "TABLE" },
                    { new Guid("a9e68076-84d2-449f-a7c2-134f09984dfb"), "hzy-admin-server/HZY.Controllers.Admin/App/", new DateTime(2022, 7, 29, 0, 0, 0, 0, DateTimeKind.Unspecified), "", "Efmigrationshistory", "hzy-admin-client/src/views/app/", "hzy-admin-client/src/views/app/", false, new DateTime(2022, 7, 30, 20, 42, 27, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/App/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/app/", "hzy-admin-server/HZY.Services.Admin/App/", "__EFMigrationsHistory", "TABLE" },
                    { new Guid("ae6d94d8-6a15-4348-b600-aa17e4b61718"), "hzy-admin-server/HZY.Controllers.Admin/App/", new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "工作流节点", "FlowNode", "hzy-admin-client/src/views/app/", "hzy-admin-client/src/views/app/", false, new DateTime(2022, 7, 30, 20, 42, 3, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/App/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/app/", "hzy-admin-server/HZY.Services.Admin/App/", "flow_node", "TABLE" },
                    { new Guid("af37f705-7ba0-4883-b1be-8a274ea4c026"), "hzy-admin-server/HZY.Controllers.Admin/App/", new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "数据字典", "SysDictionary", "hzy-admin-client/src/views/app/", "hzy-admin-client/src/views/app/", false, new DateTime(2022, 7, 30, 20, 42, 3, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/App/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/app/", "hzy-admin-server/HZY.Services.Admin/App/", "sys_dictionary", "TABLE" },
                    { new Guid("d2600250-6f32-4d7d-8395-96cc9fa36db4"), "hzy-admin-server/HZY.Controllers.Admin/App/", new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "菜单", "SysMenu", "hzy-admin-client/src/views/app/", "hzy-admin-client/src/views/app/", false, new DateTime(2022, 7, 30, 20, 42, 3, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/App/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/app/", "hzy-admin-server/HZY.Services.Admin/App/", "sys_menu", "TABLE" },
                    { new Guid("d26d07cb-158a-4cb2-8b20-5dfd5181af54"), "hzy-admin-server/HZY.Controllers.Admin/App/", new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "组织", "SysOrganization", "hzy-admin-client/src/views/app/", "hzy-admin-client/src/views/app/", false, new DateTime(2022, 7, 30, 20, 42, 3, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/App/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/app/", "hzy-admin-server/HZY.Services.Admin/App/", "sys_organization", "TABLE" },
                    { new Guid("d8948c56-c5bd-4061-b272-5417375f38f0"), "hzy-admin-server/HZY.Controllers.Admin/App/", new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "审批流审批", "FlowApproval", "hzy-admin-client/src/views/app/", "hzy-admin-client/src/views/app/", false, new DateTime(2022, 7, 30, 20, 42, 3, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/App/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/app/", "hzy-admin-server/HZY.Services.Admin/App/", "flow_approval", "TABLE" },
                    { new Guid("e79db53b-7162-4669-9b5e-f860501475ac"), "hzy-admin-server/HZY.Controllers.Admin/App/", new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "数据权限", "SysDataAuthority", "hzy-admin-client/src/views/app/", "hzy-admin-client/src/views/app/", false, new DateTime(2022, 7, 30, 20, 42, 3, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/App/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/app/", "hzy-admin-server/HZY.Services.Admin/App/", "sys_data_authority", "TABLE" },
                    { new Guid("f3d7bbb3-c1fb-4d61-92a4-9bc101811335"), "hzy-admin-server/HZY.Controllers.Admin/App/", new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "角色", "SysRole", "hzy-admin-client/src/views/app/", "hzy-admin-client/src/views/app/", false, new DateTime(2022, 7, 30, 20, 42, 3, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/App/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/app/", "hzy-admin-server/HZY.Services.Admin/App/", "sys_role", "TABLE" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, true, null, new DateTime(2021, 5, 28, 11, 49, 2, 0, DateTimeKind.Unspecified), "MoreOutlined", null, true, new DateTime(2022, 3, 4, 12, 25, 39, 0, DateTimeKind.Unspecified), "1", "更多示例", 10, null, null, true, true, 1, null });
