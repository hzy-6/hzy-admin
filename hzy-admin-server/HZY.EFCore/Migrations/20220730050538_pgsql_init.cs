        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LaunchTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    FormId = table.Column<Guid>(type: "uuid", nullable: false),
                    FlowId = table.Column<Guid>(type: "uuid", nullable: false),
                    FlowCode = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FlowNodeId = table.Column<Guid>(type: "uuid", nullable: false),
                    FlowNodeName = table.Column<string>(type: "text", nullable: true),
                    SortMore = table.Column<int>(type: "integer", nullable: false),
                    State = table.Column<int>(type: "integer", nullable: false),
                    Opinions = table.Column<string>(type: "text", nullable: true),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    UserName = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    FlowApprovalStepHistoryId = table.Column<Guid>(type: "uuid", nullable: false),
                    FlowNodeId = table.Column<Guid>(type: "uuid", nullable: false),
                    FlowNodeName = table.Column<string>(type: "text", nullable: true),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    UserName = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Low_Code_TableId = table.Column<Guid>(type: "uuid", nullable: false),
                    Low_Code_Table_InfoId = table.Column<Guid>(type: "uuid", nullable: false),
                    ForeignKeyTableId = table.Column<Guid>(type: "uuid", nullable: false),
                    ForeignKeyTableFieldName = table.Column<string>(type: "text", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Remark = table.Column<string>(type: "text", nullable: true),
                    ProjectRootPath = table.Column<string>(type: "text", nullable: true),
                    ModelPath = table.Column<string>(type: "text", nullable: true),
                    ServicePath = table.Column<string>(type: "text", nullable: true),
                    ControllerPath = table.Column<string>(type: "text", nullable: true),
                    IndexVuePath = table.Column<string>(type: "text", nullable: true),
                    InfoVuePath = table.Column<string>(type: "text", nullable: true),
                    ServiceJsPath = table.Column<string>(type: "text", nullable: true),
                    IsCover = table.Column<bool>(type: "boolean", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DatabaseColumnType = table.Column<string>(type: "text", nullable: true),
                    CsType = table.Column<string>(type: "text", nullable: true),
                    CsField = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    SysDataAuthorityId = table.Column<Guid>(type: "uuid", nullable: true),
                    SysOrganizationId = table.Column<int>(type: "integer", nullable: false),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FunctionCode = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FormBody = table.Column<string>(type: "text", nullable: true),
                    QueryString = table.Column<string>(type: "text", nullable: true),
                    TakeUpTime = table.Column<long>(type: "bigint", nullable: false),
                    Browser = table.Column<string>(type: "text", nullable: true),
                    OS = table.Column<string>(type: "text", nullable: true),
                    UserId = table.Column<Guid>(type: "uuid", nullable: true),
                    ControllerDisplayName = table.Column<string>(type: "text", nullable: true),
                    ActionDisplayName = table.Column<string>(type: "text", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "text", nullable: true),
                    Remark = table.Column<string>(type: "text", nullable: true),
                    DeleteLock = table.Column<bool>(type: "boolean", nullable: false),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoleId = table.Column<Guid>(type: "uuid", nullable: false),
                    MenuId = table.Column<int>(type: "integer", nullable: false),
                    MenuFunctionId = table.Column<Guid>(type: "uuid", nullable: false),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "ControllerPath", "CreationTime", "DisplayName", "EntityName", "IndexVuePath", "InfoVuePath", "IsCover", "LastModificationTime", "ModelPath", "ProjectRootPath", "Remark", "Schema", "ServiceJsPath", "ServicePath", "TableName", "Type" },
                values: new object[,]
                {
                    { new Guid("0a8bdb18-758a-4798-9ffc-e7031dcbf262"), "hzy-admin-server/HZY.Controllers.Admin/", new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "岗位", "SysPost", "hzy-admin-client/src/views/my/", "hzy-admin-client/src/views/my/", false, new DateTime(2022, 7, 30, 12, 46, 41, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/my/", "hzy-admin-server/HZY.Services.Admin/", "sys_post", "TABLE" },
                    { new Guid("18fbb18e-cb29-45d8-a5f3-c0121c57680a"), "hzy-admin-server/HZY.Controllers.Admin/", new DateTime(2022, 7, 29, 0, 0, 0, 0, DateTimeKind.Unspecified), "", "FlowApprovalStepHistory", "hzy-admin-client/src/views/my/", "hzy-admin-client/src/views/my/", false, new DateTime(2022, 7, 30, 12, 46, 41, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/my/", "hzy-admin-server/HZY.Services.Admin/", "flow_approval_step_history", "TABLE" },
                    { new Guid("1a8df018-79f8-4e26-b4eb-4b735aae7275"), "hzy-admin-server/HZY.Controllers.Admin/", new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "审批流", "Flow", "hzy-admin-client/src/views/my/", "hzy-admin-client/src/views/my/", false, new DateTime(2022, 7, 30, 12, 46, 41, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/my/", "hzy-admin-server/HZY.Services.Admin/", "flow", "TABLE" },
                    { new Guid("2ae9e532-7d9a-474b-b629-50a39945c44d"), "hzy-admin-server/HZY.Controllers.Admin/", new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "菜单功能", "SysMenuFunction", "hzy-admin-client/src/views/my/", "hzy-admin-client/src/views/my/", false, new DateTime(2022, 7, 30, 12, 46, 41, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/my/", "hzy-admin-server/HZY.Services.Admin/", "sys_menu_function", "TABLE" },
                    { new Guid("3da5d264-2e8d-460c-a10c-ff9a6bb57a60"), "hzy-admin-server/HZY.Controllers.Admin/", new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "用户与角色", "SysUserRole", "hzy-admin-client/src/views/my/", "hzy-admin-client/src/views/my/", false, new DateTime(2022, 7, 30, 12, 46, 41, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/my/", "hzy-admin-server/HZY.Services.Admin/", "sys_user_role", "TABLE" },
                    { new Guid("524e71b4-cbf7-4248-8b29-3f99b43f2eb2"), "hzy-admin-server/HZY.Controllers.Admin/", new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "自定义数据权限", "SysDataAuthorityCustom", "hzy-admin-client/src/views/my/", "hzy-admin-client/src/views/my/", false, new DateTime(2022, 7, 30, 12, 46, 41, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/my/", "hzy-admin-server/HZY.Services.Admin/", "sys_data_authority_custom", "TABLE" },
                    { new Guid("60cceba1-28bf-4d1d-b603-4edf95d512b8"), "hzy-admin-server/HZY.Controllers.Admin/", new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "操作日志", "SysOperationLog", "hzy-admin-client/src/views/my/", "hzy-admin-client/src/views/my/", false, new DateTime(2022, 7, 30, 12, 46, 41, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/my/", "hzy-admin-server/HZY.Services.Admin/", "sys_operation_log", "TABLE" },
                    { new Guid("6323638b-a45f-4a76-886e-69a9e9be0901"), "hzy-admin-server/HZY.Controllers.Admin/", new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "用户", "SysUser", "hzy-admin-client/src/views/my/", "hzy-admin-client/src/views/my/", false, new DateTime(2022, 7, 30, 12, 48, 34, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/my/", "hzy-admin-server/HZY.Services.Admin/", "sys_user", "TABLE" },
                    { new Guid("651bb982-1130-4e1c-9070-36b90dcf2324"), null, new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "工作流审批步骤配置", "FlowApprovalStep", null, null, false, new DateTime(2022, 7, 29, 21, 59, 11, 0, DateTimeKind.Unspecified), null, null, null, null, null, null, "flow_approval_step", null },
                    { new Guid("69b24f04-0ed3-45fc-91d9-0dc929175a57"), "hzy-admin-server/HZY.Controllers.Admin/", new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "用户与岗位", "SysUserPost", "hzy-admin-client/src/views/my/", "hzy-admin-client/src/views/my/", false, new DateTime(2022, 7, 30, 12, 46, 41, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/my/", "hzy-admin-server/HZY.Services.Admin/", "sys_user_post", "TABLE" },
                    { new Guid("69edd8a8-1d24-478c-a909-b82039edcec0"), "hzy-admin-server/HZY.Controllers.Admin/", new DateTime(2022, 5, 23, 0, 0, 0, 0, DateTimeKind.Unspecified), "低代码检索表", "LowCodeSearch", "hzy-admin-client/src/views/my/", "hzy-admin-client/src/views/my/", false, new DateTime(2022, 7, 30, 12, 46, 41, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/my/", "hzy-admin-server/HZY.Services.Admin/", "low_code_search", "TABLE" },
                    { new Guid("6ba9805c-916e-4d2c-99d0-216fcbc361cc"), "hzy-admin-server/HZY.Controllers.Admin/", new DateTime(2022, 5, 23, 0, 0, 0, 0, DateTimeKind.Unspecified), "低代码表", "LowCodeTable", "hzy-admin-client/src/views/my/", "hzy-admin-client/src/views/my/", false, new DateTime(2022, 7, 30, 12, 46, 41, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/my/", "hzy-admin-server/HZY.Services.Admin/", "low_code_table", "TABLE" },
                    { new Guid("6fabc67a-8b48-49a6-8ba1-c8a32c499d36"), "hzy-admin-server/HZY.Controllers.Admin/", new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "功能", "SysFunction", "hzy-admin-client/src/views/my/", "hzy-admin-client/src/views/my/", false, new DateTime(2022, 7, 30, 12, 46, 41, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/my/", "hzy-admin-server/HZY.Services.Admin/", "sys_function", "TABLE" },
                    { new Guid("73c97832-4e7f-4758-86d2-94327971b5fd"), "hzy-admin-server/HZY.Controllers.Admin/", new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "会员", "Member", "hzy-admin-client/src/views/my/", "hzy-admin-client/src/views/my/", false, new DateTime(2022, 7, 30, 12, 46, 41, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/my/", "hzy-admin-server/HZY.Services.Admin/", "member", "TABLE" },
                    { new Guid("79fbd4ec-9f4e-45dc-8065-70f2eb422cdf"), "hzy-admin-server/HZY.Controllers.Admin/", new DateTime(2022, 5, 23, 0, 0, 0, 0, DateTimeKind.Unspecified), "低代码表信息", "LowCodeTableInfo", "hzy-admin-client/src/views/my/", "hzy-admin-client/src/views/my/", false, new DateTime(2022, 7, 30, 12, 46, 41, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/my/", "hzy-admin-server/HZY.Services.Admin/", "low_code_table_info", "TABLE" },
                    { new Guid("7ad3b915-f0bd-443a-89cd-42d41dd6c554"), null, new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "工作流用户审批步骤", "FlowApprovalStepUser", null, null, false, new DateTime(2022, 7, 29, 21, 59, 11, 0, DateTimeKind.Unspecified), null, null, null, null, null, null, "flow_approval_step_user", null },
                    { new Guid("7f94e0db-fc63-40dc-bfe3-18c5aad75975"), "hzy-admin-server/HZY.Controllers.Admin/", new DateTime(2022, 7, 29, 0, 0, 0, 0, DateTimeKind.Unspecified), "", "FlowApprovalStepHistoryUser", "hzy-admin-client/src/views/my/", "hzy-admin-client/src/views/my/", false, new DateTime(2022, 7, 30, 12, 46, 41, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/my/", "hzy-admin-server/HZY.Services.Admin/", "flow_approval_step_history_user", "TABLE" },
                    { new Guid("852f53ff-0d00-4c32-aa55-a9c11993751b"), "hzy-admin-server/HZY.Controllers.Admin/", new DateTime(2022, 5, 23, 0, 0, 0, 0, DateTimeKind.Unspecified), "低代码列表", "LowCodeList", "hzy-admin-client/src/views/my/", "hzy-admin-client/src/views/my/", false, new DateTime(2022, 7, 30, 12, 46, 41, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/my/", "hzy-admin-server/HZY.Services.Admin/", "low_code_list", "TABLE" },
                    { new Guid("8da38d20-8a09-4e81-8dd8-ed6702aee380"), "hzy-admin-server/HZY.Controllers.Admin/", new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "角色菜单功能关联", "SysRoleMenuFunction", "hzy-admin-client/src/views/my/", "hzy-admin-client/src/views/my/", false, new DateTime(2022, 7, 30, 12, 46, 41, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/my/", "hzy-admin-server/HZY.Services.Admin/", "sys_role_menu_function", "TABLE" },
                    { new Guid("a9e68076-84d2-449f-a7c2-134f09984dfb"), "hzy-admin-server/HZY.Controllers.Admin/", new DateTime(2022, 7, 29, 0, 0, 0, 0, DateTimeKind.Unspecified), "", "Efmigrationshistory", "hzy-admin-client/src/views/my/", "hzy-admin-client/src/views/my/", false, new DateTime(2022, 7, 30, 12, 46, 41, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/my/", "hzy-admin-server/HZY.Services.Admin/", "__EFMigrationsHistory", "TABLE" },
                    { new Guid("ae6d94d8-6a15-4348-b600-aa17e4b61718"), "hzy-admin-server/HZY.Controllers.Admin/", new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "工作流节点", "FlowNode", "hzy-admin-client/src/views/my/", "hzy-admin-client/src/views/my/", false, new DateTime(2022, 7, 30, 12, 46, 41, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/my/", "hzy-admin-server/HZY.Services.Admin/", "flow_node", "TABLE" },
                    { new Guid("af37f705-7ba0-4883-b1be-8a274ea4c026"), "hzy-admin-server/HZY.Controllers.Admin/", new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "数据字典", "SysDictionary", "hzy-admin-client/src/views/my/", "hzy-admin-client/src/views/my/", false, new DateTime(2022, 7, 30, 12, 46, 41, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/my/", "hzy-admin-server/HZY.Services.Admin/", "sys_dictionary", "TABLE" },
                    { new Guid("d2600250-6f32-4d7d-8395-96cc9fa36db4"), "hzy-admin-server/HZY.Controllers.Admin/", new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "菜单", "SysMenu", "hzy-admin-client/src/views/my/", "hzy-admin-client/src/views/my/", false, new DateTime(2022, 7, 30, 12, 46, 41, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/my/", "hzy-admin-server/HZY.Services.Admin/", "sys_menu", "TABLE" },
                    { new Guid("d26d07cb-158a-4cb2-8b20-5dfd5181af54"), "hzy-admin-server/HZY.Controllers.Admin/", new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "组织", "SysOrganization", "hzy-admin-client/src/views/my/", "hzy-admin-client/src/views/my/", false, new DateTime(2022, 7, 30, 12, 46, 41, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/my/", "hzy-admin-server/HZY.Services.Admin/", "sys_organization", "TABLE" },
                    { new Guid("d8948c56-c5bd-4061-b272-5417375f38f0"), "hzy-admin-server/HZY.Controllers.Admin/", new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "审批流审批", "FlowApproval", "hzy-admin-client/src/views/my/", "hzy-admin-client/src/views/my/", false, new DateTime(2022, 7, 30, 12, 46, 41, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/my/", "hzy-admin-server/HZY.Services.Admin/", "flow_approval", "TABLE" },
                    { new Guid("e79db53b-7162-4669-9b5e-f860501475ac"), "hzy-admin-server/HZY.Controllers.Admin/", new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "数据权限", "SysDataAuthority", "hzy-admin-client/src/views/my/", "hzy-admin-client/src/views/my/", false, new DateTime(2022, 7, 30, 12, 46, 41, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/my/", "hzy-admin-server/HZY.Services.Admin/", "sys_data_authority", "TABLE" },
                    { new Guid("f3d7bbb3-c1fb-4d61-92a4-9bc101811335"), "hzy-admin-server/HZY.Controllers.Admin/", new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "角色", "SysRole", "hzy-admin-client/src/views/my/", "hzy-admin-client/src/views/my/", false, new DateTime(2022, 7, 30, 12, 46, 41, 0, DateTimeKind.Unspecified), "hzy-admin-server/HZY.Models/Entities/", "HzyAdmin", null, "dbo", "hzy-admin-client/src/service/my/", "hzy-admin-server/HZY.Services.Admin/", "sys_role", "TABLE" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("022c287a-11e3-4234-3392-08da716a5c08"), "UserName", new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), "UserName", "String", "nvarchar(MAX)", "", "", false, true, false, new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), new Guid("18fbb18e-cb29-45d8-a5f3-c0121c57680a"), -1, 28 },
                    { new Guid("042a59e2-72c1-4c38-d52d-08da3d8d5a26"), "ParentId", new DateTime(2022, 5, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "ParentId", "Int32", "int", "", null, false, true, false, new DateTime(2022, 6, 9, 21, 20, 26, 0, DateTimeKind.Unspecified), new Guid("d26d07cb-158a-4cb2-8b20-5dfd5181af54"), null, 140 },
                    ...
                    { new Guid("0b45e9bb-b9f1-4a2f-d526-08da3d8d5a26"), "CreationTime", new DateTime(2022, 5, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "CreationTime", "DateTime", "datetime2", "", null, false, true, false, new DateTime(2022, 6, 9, 21, 20, 26, 0, DateTimeKind.Unspecified), new Guid("d26d07cb-158a-4cb2-8b20-5dfd5181af54"), null, 142 },
                    ...
                    { new Guid("0f1a8b93-eb7b-4a86-3385-08da716a5c08"), "LastModificationTime", new DateTime(2022, 7, 29, 0, 0, 0, 0, DateTimeKind.Unspecified), "LastModificationTime", "DateTime", "datetime2", "", "更新时间", false, true, false, new DateTime(2022, 7, 29, 22, 9, 7, 0, DateTimeKind.Unspecified), new Guid("181eef0c-8d00-4b6c-a3dd-59761cdb88d7"), null, 215 },
                    ...
                    { new Guid("1121d642-49e8-4b25-d52b-08da3d8d5a26"), "Name", new DateTime(2022, 5, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "Name", "String", "nvarchar(255)", "", "组织名称", false, true, false, new DateTime(2022, 6, 9, 21, 20, 26, 0, DateTimeKind.Unspecified), new Guid("d26d07cb-158a-4cb2-8b20-5dfd5181af54"), null, 133 },
                    ...
                    { new Guid("11f3d291-cf7a-4143-d52a-08da3d8d5a26"), "LevelCode", new DateTime(2022, 5, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "LevelCode", "String", "varchar(50)", "", null, false, true, false, new DateTime(2022, 6, 9, 21, 20, 26, 0, DateTimeKind.Unspecified), new Guid("d26d07cb-158a-4cb2-8b20-5dfd5181af54"), null, 135 },
                    ...
                    { new Guid("13775de6-200d-43e0-244c-08da717dbcaa"), "ServiceJsPath", new DateTime(2022, 7, 30, 0, 16, 47, 0, DateTimeKind.Unspecified), "ServiceJsPath", "String", "varchar(50)", "", "", false, true, false, new DateTime(2022, 7, 30, 0, 16, 47, 0, DateTimeKind.Unspecified), new Guid("6ba9805c-916e-4d2c-99d0-216fcbc361cc"), 50, 218 },
                    { new Guid("158b1c2d-fa67-4696-244b-08da717dbcaa"), "Schema", new DateTime(2022, 7, 30, 0, 16, 47, 0, DateTimeKind.Unspecified), "Schema", "String", "nvarchar(MAX)", "", "", false, true, false, new DateTime(2022, 7, 30, 0, 16, 47, 0, DateTimeKind.Unspecified), new Guid("6ba9805c-916e-4d2c-99d0-216fcbc361cc"), -1, 207 },
                    ...
                    { new Guid("19a7504c-f740-4b49-d528-08da3d8d5a26"), "LastModificationTime", new DateTime(2022, 5, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "LastModificationTime", "DateTime", "datetime2", "", null, false, true, false, new DateTime(2022, 6, 9, 21, 20, 26, 0, DateTimeKind.Unspecified), new Guid("d26d07cb-158a-4cb2-8b20-5dfd5181af54"), null, 141 },
                    ...
                    { new Guid("1bd2134c-3a2a-4e1b-2446-08da717dbcaa"), "IsCover", new DateTime(2022, 7, 30, 0, 16, 47, 0, DateTimeKind.Unspecified), "IsCover", "Boolean", "bit", "", "", false, true, false, new DateTime(2022, 7, 30, 0, 16, 47, 0, DateTimeKind.Unspecified), new Guid("6ba9805c-916e-4d2c-99d0-216fcbc361cc"), 1, 219 },
                    ...
                    { new Guid("1fbf9cea-3e4c-401b-243f-08da717dbcaa"), "Id", new DateTime(2022, 7, 30, 0, 16, 47, 0, DateTimeKind.Unspecified), "Id", "Guid", "uniqueidentifier", "", "", false, false, true, new DateTime(2022, 7, 30, 0, 16, 47, 0, DateTimeKind.Unspecified), new Guid("6ba9805c-916e-4d2c-99d0-216fcbc361cc"), 16, 203 },
                    ...
                    { new Guid("2250683d-eb83-401b-33a4-08da716a5c08"), "Name", new DateTime(2022, 7, 29, 0, 0, 0, 0, DateTimeKind.Unspecified), "Name", "String", "varchar(255)", "学生名称", "学生名称", false, true, false, new DateTime(2022, 7, 29, 22, 11, 14, 0, DateTimeKind.Unspecified), new Guid("a896fe8b-b3e1-4227-95b4-defc56ceb98b"), null, 217 },
                    { new Guid("22527fe7-bd5c-4e6c-3389-08da716a5c08"), "CreationTime", new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), "CreationTime", "DateTime", "datetime2", "", "", false, false, false, new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), new Guid("18fbb18e-cb29-45d8-a5f3-c0121c57680a"), 8, 31 },
                    ...
                    { new Guid("26f16d3d-9c42-4f86-244e-08da717dbcaa"), "TableName", new DateTime(2022, 7, 30, 0, 16, 47, 0, DateTimeKind.Unspecified), "TableName", "String", "nvarchar(MAX)", "", "", false, true, false, new DateTime(2022, 7, 30, 0, 16, 47, 0, DateTimeKind.Unspecified), new Guid("6ba9805c-916e-4d2c-99d0-216fcbc361cc"), -1, 206 },
                    ...
                    { new Guid("287314b2-3141-4957-d548-08da3d8d5a26"), "Email", new DateTime(2022, 5, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "Email", "String", "nvarchar(255)", "", "电子邮箱", false, false, false, new DateTime(2022, 6, 9, 21, 20, 4, 0, DateTimeKind.Unspecified), new Guid("6323638b-a45f-4a76-886e-69a9e9be0901"), null, 171 },
                    ...
                    { new Guid("3051fb7c-f075-4d91-2443-08da717dbcaa"), "EntityName", new DateTime(2022, 7, 30, 0, 16, 47, 0, DateTimeKind.Unspecified), "EntityName", "String", "nvarchar(MAX)", "", "", false, true, false, new DateTime(2022, 7, 30, 0, 16, 47, 0, DateTimeKind.Unspecified), new Guid("6ba9805c-916e-4d2c-99d0-216fcbc361cc"), -1, 210 },
                    ...
                    { new Guid("30a89871-1833-4ab4-339e-08da716a5c08"), "LastModificationTime", new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), "LastModificationTime", "DateTime", "datetime2", "", "", false, true, false, new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), new Guid("7727e0c1-28a4-4112-8cd1-bc69dd5e57ad"), 6, 220 },
                    ...
                    { new Guid("3d9c98e4-2ac7-40fd-3391-08da716a5c08"), "UserId", new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), "UserId", "Guid", "uniqueidentifier", "", "", false, false, false, new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), new Guid("18fbb18e-cb29-45d8-a5f3-c0121c57680a"), 16, 27 },
                    { new Guid("3dc28fb4-11cf-4b52-339f-08da716a5c08"), "Name", new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), "Name", "String", "varchar(255)", "学生名称", "学生名称", false, true, false, new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), new Guid("7727e0c1-28a4-4112-8cd1-bc69dd5e57ad"), 255, 217 },
                    ...
                    { new Guid("46bac66f-3cf0-46b3-d546-08da3d8d5a26"), "CreationTime", new DateTime(2022, 5, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "CreationTime", "DateTime", "datetime2", "", "创建时间", false, true, false, new DateTime(2022, 6, 9, 21, 20, 4, 0, DateTimeKind.Unspecified), new Guid("6323638b-a45f-4a76-886e-69a9e9be0901"), null, 166 },
                    ...
                    { new Guid("4b5bc027-5663-463a-d54b-08da3d8d5a26"), "Name", new DateTime(2022, 5, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "Name", "String", "nvarchar(255)", "", "用户名称", false, true, false, new DateTime(2022, 6, 9, 21, 20, 4, 0, DateTimeKind.Unspecified), new Guid("6323638b-a45f-4a76-886e-69a9e9be0901"), null, 167 },
                    ...
                    { new Guid("50b6b2fc-3e73-457c-338b-08da716a5c08"), "FlowNodeName", new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), "FlowNodeName", "String", "nvarchar(MAX)", "", "", false, true, false, new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), new Guid("18fbb18e-cb29-45d8-a5f3-c0121c57680a"), -1, 23 },
                    ...
                    { new Guid("51d2eb90-7ab9-4763-3387-08da716a5c08"), "Id", new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), "Id", "Guid", "uniqueidentifier", "", "", false, false, true, new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), new Guid("18fbb18e-cb29-45d8-a5f3-c0121c57680a"), 16, 20 },
                    ...
                    { new Guid("54a0ed42-104e-4e2a-2445-08da717dbcaa"), "InfoVuePath", new DateTime(2022, 7, 30, 0, 16, 47, 0, DateTimeKind.Unspecified), "InfoVuePath", "String", "varchar(50)", "", "", false, true, false, new DateTime(2022, 7, 30, 0, 16, 47, 0, DateTimeKind.Unspecified), new Guid("6ba9805c-916e-4d2c-99d0-216fcbc361cc"), 50, 217 },
                    { new Guid("55242f55-b8e4-469a-33a2-08da716a5c08"), "CreationTime", new DateTime(2022, 7, 29, 0, 0, 0, 0, DateTimeKind.Unspecified), "CreationTime", "DateTime", "datetime2", "", "创建时间", false, true, false, new DateTime(2022, 7, 29, 22, 11, 14, 0, DateTimeKind.Unspecified), new Guid("a896fe8b-b3e1-4227-95b4-defc56ceb98b"), null, 219 },
                    { new Guid("5541e535-7cbe-43d2-d4d4-08da3d8d5a26"), "CreationTime", new DateTime(2022, 5, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "CreationTime", "DateTime", "datetime2", "创建时间", "创建时间", false, true, false, new DateTime(2022, 6, 8, 21, 20, 4, 0, DateTimeKind.Unspecified), new Guid("73c97832-4e7f-4758-86d2-94327971b5fd"), null, 80 },
                    ...
                    { new Guid("59cfb48c-8d3f-43d7-244f-08da717dbcaa"), "Type", new DateTime(2022, 7, 30, 0, 16, 47, 0, DateTimeKind.Unspecified), "Type", "String", "nvarchar(MAX)", "", "", false, true, false, new DateTime(2022, 7, 30, 0, 16, 47, 0, DateTimeKind.Unspecified), new Guid("6ba9805c-916e-4d2c-99d0-216fcbc361cc"), -1, 208 },
                    { new Guid("59f5d993-e502-4fee-3393-08da716a5c08"), "Id", new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), "Id", "Guid", "uniqueidentifier", "", "", false, false, true, new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), new Guid("7f94e0db-fc63-40dc-bfe3-18c5aad75975"), 16, 32 },
                    { new Guid("5a9fa990-b6d6-445f-d54c-08da3d8d5a26"), "OrganizationId", new DateTime(2022, 5, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "OrganizationId", "Int32", "int", "", "组织id", false, true, false, new DateTime(2022, 6, 9, 21, 20, 4, 0, DateTimeKind.Unspecified), new Guid("6323638b-a45f-4a76-886e-69a9e9be0901"), null, 173 },
                    ...
                    { new Guid("5aed3feb-3d77-4e1e-d52c-08da3d8d5a26"), "OrderNumber", new DateTime(2022, 5, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "OrderNumber", "Int32", "int", "", null, false, true, false, new DateTime(2022, 6, 9, 21, 20, 26, 0, DateTimeKind.Unspecified), new Guid("d26d07cb-158a-4cb2-8b20-5dfd5181af54"), null, 134 },
                    { new Guid("5b37ee9f-fe5d-48f3-339b-08da716a5c08"), "Id", new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), "Id", "Guid", "uniqueidentifier", "", "", false, false, true, new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), new Guid("7727e0c1-28a4-4112-8cd1-bc69dd5e57ad"), 16, 216 },
                    { new Guid("5bcf7406-75cc-4171-d545-08da3d8d5a26"), "Id", new DateTime(2022, 5, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "Id", "Guid", "uniqueidentifier", "", null, false, false, true, new DateTime(2022, 6, 9, 21, 20, 4, 0, DateTimeKind.Unspecified), new Guid("6323638b-a45f-4a76-886e-69a9e9be0901"), null, 164 },
                    ...
                    { new Guid("643c3aa6-d639-46bd-339a-08da716a5c08"), "UserName", new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), "UserName", "String", "nvarchar(MAX)", "", "", false, true, false, new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), new Guid("7f94e0db-fc63-40dc-bfe3-18c5aad75975"), -1, 37 },
                    ...
                    { new Guid("656c384c-5ae8-4d4a-3384-08da716a5c08"), "CreationTime", new DateTime(2022, 7, 29, 0, 0, 0, 0, DateTimeKind.Unspecified), "CreationTime", "DateTime", "datetime2", "", "创建时间", false, true, false, new DateTime(2022, 7, 29, 22, 9, 7, 0, DateTimeKind.Unspecified), new Guid("181eef0c-8d00-4b6c-a3dd-59761cdb88d7"), null, 214 },
                    ...
                    { new Guid("669b87ce-c694-4c8c-d4da-08da3d8d5a26"), "Phone", new DateTime(2022, 5, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "Phone", "String", "nvarchar(255)", "", "联系电话", false, true, false, new DateTime(2022, 6, 8, 21, 20, 4, 0, DateTimeKind.Unspecified), new Guid("73c97832-4e7f-4758-86d2-94327971b5fd"), null, 73 },
                    ...
                    { new Guid("70e3ad35-4ffa-4a96-3382-08da716a5c08"), "ProductVersion", new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), "ProductVersion", "String", "nvarchar(32)", "", "", false, false, false, new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), new Guid("a9e68076-84d2-449f-a7c2-134f09984dfb"), 32, 2 },
                    ...
                    { new Guid("72ac247c-d792-4fee-d4dc-08da3d8d5a26"), "Sex", new DateTime(2022, 5, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "Sex", "String", "nvarchar(255)", "", "性别", false, true, false, new DateTime(2022, 6, 8, 21, 20, 4, 0, DateTimeKind.Unspecified), new Guid("73c97832-4e7f-4758-86d2-94327971b5fd"), null, 74 },
                    ...
                    { new Guid("7485deed-e9e8-4aa6-338a-08da716a5c08"), "FlowNodeId", new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), "FlowNodeId", "Guid", "uniqueidentifier", "", "", false, false, false, new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), new Guid("18fbb18e-cb29-45d8-a5f3-c0121c57680a"), 16, 22 },
                    ...
                    { new Guid("79d371fb-b37a-4d32-3390-08da716a5c08"), "State", new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), "State", "Int32", "int", "", "", false, false, false, new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), new Guid("18fbb18e-cb29-45d8-a5f3-c0121c57680a"), 4, 25 },
                    ...
                    { new Guid("7cbe8988-cbac-4ea2-d54a-08da3d8d5a26"), "LoginName", new DateTime(2022, 5, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "LoginName", "String", "nvarchar(255)", "", "登录名称", false, true, false, new DateTime(2022, 6, 9, 21, 20, 4, 0, DateTimeKind.Unspecified), new Guid("6323638b-a45f-4a76-886e-69a9e9be0901"), null, 168 },
                    { new Guid("7ec46123-3852-4b62-2440-08da717dbcaa"), "ControllerPath", new DateTime(2022, 7, 30, 0, 16, 47, 0, DateTimeKind.Unspecified), "ControllerPath", "String", "varchar(50)", "", "", false, true, false, new DateTime(2022, 7, 30, 0, 16, 47, 0, DateTimeKind.Unspecified), new Guid("6ba9805c-916e-4d2c-99d0-216fcbc361cc"), 50, 215 },
                    { new Guid("803c2d4b-4a80-43b0-244a-08da717dbcaa"), "Remark", new DateTime(2022, 7, 30, 0, 16, 47, 0, DateTimeKind.Unspecified), "Remark", "String", "nvarchar(MAX)", "", "", false, true, false, new DateTime(2022, 7, 30, 0, 16, 47, 0, DateTimeKind.Unspecified), new Guid("6ba9805c-916e-4d2c-99d0-216fcbc361cc"), -1, 211 },
                    ...
                    { new Guid("8326ca11-09f1-4c38-d4d6-08da3d8d5a26"), "Introduce", new DateTime(2022, 5, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "Introduce", "String", "nvarchar(255)", "", "简介", false, true, false, new DateTime(2022, 6, 8, 21, 20, 4, 0, DateTimeKind.Unspecified), new Guid("73c97832-4e7f-4758-86d2-94327971b5fd"), null, 77 },
                    { new Guid("837b058b-a88e-4107-d4dd-08da3d8d5a26"), "UserId", new DateTime(2022, 5, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "UserId", "Guid", "uniqueidentifier", "所属用户", "所属用户", false, true, false, new DateTime(2022, 6, 8, 21, 20, 4, 0, DateTimeKind.Unspecified), new Guid("73c97832-4e7f-4758-86d2-94327971b5fd"), null, 79 },
                    ...
                    { new Guid("897a208c-2e13-46f1-d4d7-08da3d8d5a26"), "LastModificationTime", new DateTime(2022, 5, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "LastModificationTime", "DateTime", "datetime2", "更新时间", "更新时间", false, true, false, new DateTime(2022, 6, 8, 21, 20, 4, 0, DateTimeKind.Unspecified), new Guid("73c97832-4e7f-4758-86d2-94327971b5fd"), null, 81 },
                    ...
                    { new Guid("8e260d55-f309-4fb2-33a1-08da716a5c08"), "ClassId", new DateTime(2022, 7, 29, 0, 0, 0, 0, DateTimeKind.Unspecified), "ClassId", "Guid", "uniqueidentifier", "班级Id", "班级Id", false, true, false, new DateTime(2022, 7, 29, 22, 11, 14, 0, DateTimeKind.Unspecified), new Guid("a896fe8b-b3e1-4227-95b4-defc56ceb98b"), null, 218 },
                    { new Guid("8e5f9439-6b90-423a-2447-08da717dbcaa"), "LastModificationTime", new DateTime(2022, 7, 30, 0, 16, 47, 0, DateTimeKind.Unspecified), "LastModificationTime", "DateTime", "datetime2", "", "", false, false, false, new DateTime(2022, 7, 30, 0, 16, 47, 0, DateTimeKind.Unspecified), new Guid("6ba9805c-916e-4d2c-99d0-216fcbc361cc"), 8, 204 },
                    { new Guid("8f107c7c-e4f5-4647-338f-08da716a5c08"), "SortMore", new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), "SortMore", "Int32", "int", "", "", false, false, false, new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), new Guid("18fbb18e-cb29-45d8-a5f3-c0121c57680a"), 4, 24 },
                    { new Guid("9059bf44-23a0-4e12-3399-08da716a5c08"), "UserId", new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), "UserId", "Guid", "uniqueidentifier", "", "", false, false, false, new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), new Guid("7f94e0db-fc63-40dc-bfe3-18c5aad75975"), 16, 36 },
                    ...
                    { new Guid("92da4c9a-a430-493e-3381-08da716a5c08"), "MigrationId", new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), "MigrationId", "String", "nvarchar(150)", "", "", false, false, true, new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), new Guid("a9e68076-84d2-449f-a7c2-134f09984dfb"), 150, 1 },
                    { new Guid("95414873-486d-4609-338e-08da716a5c08"), "Sort", new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), "Sort", "Int32", "int", "", "", false, false, false, new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), new Guid("18fbb18e-cb29-45d8-a5f3-c0121c57680a"), 4, 21 },
                    ...
                    { new Guid("a06381ef-e532-4b7a-2442-08da717dbcaa"), "DisplayName", new DateTime(2022, 7, 30, 0, 16, 47, 0, DateTimeKind.Unspecified), "DisplayName", "String", "nvarchar(MAX)", "", "", false, true, false, new DateTime(2022, 7, 30, 0, 16, 47, 0, DateTimeKind.Unspecified), new Guid("6ba9805c-916e-4d2c-99d0-216fcbc361cc"), -1, 209 },
                    ...
                    { new Guid("a105f05f-c1be-4883-3383-08da716a5c08"), "Id", new DateTime(2022, 7, 29, 0, 0, 0, 0, DateTimeKind.Unspecified), "Id", "Guid", "uniqueidentifier", "", "", false, false, true, new DateTime(2022, 7, 29, 22, 9, 7, 0, DateTimeKind.Unspecified), new Guid("181eef0c-8d00-4b6c-a3dd-59761cdb88d7"), null, 212 },
                    ...
                    { new Guid("a6752bd9-f3d6-451f-d547-08da3d8d5a26"), "DeleteLock", new DateTime(2022, 5, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "DeleteLock", "Boolean", "bit", "", "删除锁", false, true, false, new DateTime(2022, 6, 9, 21, 20, 4, 0, DateTimeKind.Unspecified), new Guid("6323638b-a45f-4a76-886e-69a9e9be0901"), null, 172 },
                    { new Guid("a7263191-1e30-42c5-3396-08da716a5c08"), "FlowNodeId", new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), "FlowNodeId", "Guid", "uniqueidentifier", "", "", false, false, false, new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), new Guid("7f94e0db-fc63-40dc-bfe3-18c5aad75975"), 16, 34 },
                    ...
                    { new Guid("aaecfda3-f48d-4cd5-244d-08da717dbcaa"), "ServicePath", new DateTime(2022, 7, 30, 0, 16, 47, 0, DateTimeKind.Unspecified), "ServicePath", "String", "varchar(50)", "", "", false, true, false, new DateTime(2022, 7, 30, 0, 16, 47, 0, DateTimeKind.Unspecified), new Guid("6ba9805c-916e-4d2c-99d0-216fcbc361cc"), 50, 214 },
                    ...
                    { new Guid("b755e2af-1164-47de-2444-08da717dbcaa"), "IndexVuePath", new DateTime(2022, 7, 30, 0, 16, 47, 0, DateTimeKind.Unspecified), "IndexVuePath", "String", "varchar(50)", "", "", false, true, false, new DateTime(2022, 7, 30, 0, 16, 47, 0, DateTimeKind.Unspecified), new Guid("6ba9805c-916e-4d2c-99d0-216fcbc361cc"), 50, 216 },
                    ...
                    { new Guid("b7fbb61f-94fc-4242-d4d3-08da3d8d5a26"), "Birthday", new DateTime(2022, 5, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "Birthday", "DateTime", "datetime2", "", "生日", false, true, false, new DateTime(2022, 6, 8, 21, 20, 4, 0, DateTimeKind.Unspecified), new Guid("73c97832-4e7f-4758-86d2-94327971b5fd"), null, 75 },
                    ...
                    { new Guid("b9bfca2e-f72b-4a3f-d52f-08da3d8d5a26"), "State", new DateTime(2022, 5, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "State", "Int32", "int", "", null, false, true, false, new DateTime(2022, 6, 9, 21, 20, 26, 0, DateTimeKind.Unspecified), new Guid("d26d07cb-158a-4cb2-8b20-5dfd5181af54"), null, 139 },
                    { new Guid("b9e8adb6-3790-4690-33a0-08da716a5c08"), "Id", new DateTime(2022, 7, 29, 0, 0, 0, 0, DateTimeKind.Unspecified), "Id", "Guid", "uniqueidentifier", "", "", false, false, true, new DateTime(2022, 7, 29, 22, 11, 14, 0, DateTimeKind.Unspecified), new Guid("a896fe8b-b3e1-4227-95b4-defc56ceb98b"), null, 216 },
                    ...
                    { new Guid("be6f08b8-b14b-4253-2441-08da717dbcaa"), "CreationTime", new DateTime(2022, 7, 30, 0, 16, 47, 0, DateTimeKind.Unspecified), "CreationTime", "DateTime", "datetime2", "", "", false, false, false, new DateTime(2022, 7, 30, 0, 16, 47, 0, DateTimeKind.Unspecified), new Guid("6ba9805c-916e-4d2c-99d0-216fcbc361cc"), 8, 205 },
                    ...
                    { new Guid("bf24a276-6ed0-49d4-d4d9-08da3d8d5a26"), "Number", new DateTime(2022, 5, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "Number", "String", "nvarchar(255)", "", "编号", false, true, false, new DateTime(2022, 6, 8, 21, 20, 4, 0, DateTimeKind.Unspecified), new Guid("73c97832-4e7f-4758-86d2-94327971b5fd"), null, 71 },
                    { new Guid("bf3dbedf-ade0-4e20-338d-08da716a5c08"), "Opinions", new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), "Opinions", "String", "nvarchar(MAX)", "", "", false, true, false, new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), new Guid("18fbb18e-cb29-45d8-a5f3-c0121c57680a"), -1, 26 },
                    ...
                    { new Guid("c1ae4945-25fc-45e9-3388-08da716a5c08"), "ApprovalDate", new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), "ApprovalDate", "DateTime", "datetime2", "", "", false, false, false, new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), new Guid("18fbb18e-cb29-45d8-a5f3-c0121c57680a"), 8, 29 },
                    ...
                    { new Guid("c6042620-d052-4a60-2448-08da717dbcaa"), "ModelPath", new DateTime(2022, 7, 30, 0, 16, 47, 0, DateTimeKind.Unspecified), "ModelPath", "String", "varchar(50)", "", "", false, true, false, new DateTime(2022, 7, 30, 0, 16, 47, 0, DateTimeKind.Unspecified), new Guid("6ba9805c-916e-4d2c-99d0-216fcbc361cc"), 50, 213 },
                    ...
                    { new Guid("c82d5132-6cda-463e-d54e-08da3d8d5a26"), "Phone", new DateTime(2022, 5, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "Phone", "String", "nvarchar(255)", "", "联系电话", false, true, false, new DateTime(2022, 6, 9, 21, 20, 4, 0, DateTimeKind.Unspecified), new Guid("6323638b-a45f-4a76-886e-69a9e9be0901"), null, 170 },
                    ...
                    { new Guid("caff37bf-4e91-4934-2449-08da717dbcaa"), "ProjectRootPath", new DateTime(2022, 7, 30, 0, 16, 47, 0, DateTimeKind.Unspecified), "ProjectRootPath", "String", "varchar(50)", "", "", false, true, false, new DateTime(2022, 7, 30, 0, 16, 47, 0, DateTimeKind.Unspecified), new Guid("6ba9805c-916e-4d2c-99d0-216fcbc361cc"), 50, 212 },
                    { new Guid("cb4a19d3-35dd-416d-3394-08da716a5c08"), "CreationTime", new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), "CreationTime", "DateTime", "datetime2", "", "", false, false, false, new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), new Guid("7f94e0db-fc63-40dc-bfe3-18c5aad75975"), 8, 39 },
                    ...
                    { new Guid("ccc3f055-79c4-4e63-3397-08da716a5c08"), "FlowNodeName", new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), "FlowNodeName", "String", "nvarchar(MAX)", "", "", false, true, false, new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), new Guid("7f94e0db-fc63-40dc-bfe3-18c5aad75975"), -1, 35 },
                    { new Guid("ce802713-74f5-4f30-d527-08da3d8d5a26"), "Email", new DateTime(2022, 5, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "Email", "String", "nvarchar(255)", "", null, false, true, false, new DateTime(2022, 6, 9, 21, 20, 26, 0, DateTimeKind.Unspecified), new Guid("d26d07cb-158a-4cb2-8b20-5dfd5181af54"), null, 138 },
                    { new Guid("cf2e3691-ab88-4420-d529-08da3d8d5a26"), "Leader", new DateTime(2022, 5, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "Leader", "String", "nvarchar(255)", "", null, false, true, false, new DateTime(2022, 6, 9, 21, 20, 26, 0, DateTimeKind.Unspecified), new Guid("d26d07cb-158a-4cb2-8b20-5dfd5181af54"), null, 136 },
                    ...
                    { new Guid("d1eb49cf-c053-4226-d4d8-08da3d8d5a26"), "Name", new DateTime(2022, 5, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "Name", "String", "nvarchar(255)", "", "会员名称", false, true, false, new DateTime(2022, 6, 8, 21, 20, 4, 0, DateTimeKind.Unspecified), new Guid("73c97832-4e7f-4758-86d2-94327971b5fd"), null, 72 },
                    ...
                    { new Guid("d550fb44-f912-434e-3395-08da716a5c08"), "FlowApprovalStepHistoryId", new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), "FlowApprovalStepHistoryId", "Guid", "uniqueidentifier", "", "", false, false, false, new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), new Guid("7f94e0db-fc63-40dc-bfe3-18c5aad75975"), 16, 33 },
                    { new Guid("d5e76d95-beed-43c9-3398-08da716a5c08"), "LastModificationTime", new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), "LastModificationTime", "DateTime", "datetime2", "", "", false, false, false, new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), new Guid("7f94e0db-fc63-40dc-bfe3-18c5aad75975"), 8, 38 },
                    { new Guid("d6008705-0d21-42ac-d525-08da3d8d5a26"), "Id", new DateTime(2022, 5, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "Id", "Int32", "int", "", null, true, false, true, new DateTime(2022, 6, 9, 21, 20, 26, 0, DateTimeKind.Unspecified), new Guid("d26d07cb-158a-4cb2-8b20-5dfd5181af54"), null, 132 },
                    { new Guid("db4510e1-40d2-4db4-338c-08da716a5c08"), "LastModificationTime", new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), "LastModificationTime", "DateTime", "datetime2", "", "", false, false, false, new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), new Guid("18fbb18e-cb29-45d8-a5f3-c0121c57680a"), 8, 30 },
                    ...
                    { new Guid("e36410b5-cb7c-4fc3-d54d-08da3d8d5a26"), "Password", new DateTime(2022, 5, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "Password", "String", "nvarchar(255)", "", "密码", false, true, false, new DateTime(2022, 6, 9, 21, 20, 4, 0, DateTimeKind.Unspecified), new Guid("6323638b-a45f-4a76-886e-69a9e9be0901"), null, 169 },
                    { new Guid("e4245f5f-bffa-43f0-d4d5-08da3d8d5a26"), "FilePath", new DateTime(2022, 5, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "FilePath", "String", "nvarchar(255)", "文件地址", "文件地址", false, true, false, new DateTime(2022, 6, 8, 21, 20, 4, 0, DateTimeKind.Unspecified), new Guid("73c97832-4e7f-4758-86d2-94327971b5fd"), null, 78 },
                    ...
                    { new Guid("e5418d61-916f-45fd-d549-08da3d8d5a26"), "LastModificationTime", new DateTime(2022, 5, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "LastModificationTime", "DateTime", "datetime2", "", "更新时间", false, true, false, new DateTime(2022, 6, 9, 21, 20, 4, 0, DateTimeKind.Unspecified), new Guid("6323638b-a45f-4a76-886e-69a9e9be0901"), null, 165 },
                    ...
                    { new Guid("e75b8650-ee49-4f83-d4d2-08da3d8d5a26"), "Id", new DateTime(2022, 5, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "Id", "Guid", "uniqueidentifier", "", null, false, false, true, new DateTime(2022, 6, 8, 21, 20, 4, 0, DateTimeKind.Unspecified), new Guid("73c97832-4e7f-4758-86d2-94327971b5fd"), null, 70 },
                    ...
                    { new Guid("e98a9b6c-1592-43f7-339c-08da716a5c08"), "ClassId", new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), "ClassId", "Guid", "uniqueidentifier", "班级Id", "班级Id", false, true, false, new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), new Guid("7727e0c1-28a4-4112-8cd1-bc69dd5e57ad"), 16, 218 },
                    { new Guid("ea63351c-c203-4d40-d52e-08da3d8d5a26"), "Phone", new DateTime(2022, 5, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "Phone", "String", "nvarchar(255)", "", null, false, true, false, new DateTime(2022, 6, 9, 21, 20, 26, 0, DateTimeKind.Unspecified), new Guid("d26d07cb-158a-4cb2-8b20-5dfd5181af54"), null, 137 },
                    ...
                    { new Guid("ef33189a-e074-42e0-339d-08da716a5c08"), "CreationTime", new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), "CreationTime", "DateTime", "datetime2", "", "", false, true, false, new DateTime(2022, 7, 29, 21, 58, 5, 0, DateTimeKind.Unspecified), new Guid("7727e0c1-28a4-4112-8cd1-bc69dd5e57ad"), 6, 219 },
                    ...
                    { new Guid("f03ac01c-e0cf-4f13-d4db-08da3d8d5a26"), "Photo", new DateTime(2022, 5, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "Photo", "String", "nvarchar(255)", "", "头像", false, true, false, new DateTime(2022, 6, 8, 21, 20, 4, 0, DateTimeKind.Unspecified), new Guid("73c97832-4e7f-4758-86d2-94327971b5fd"), null, 76 },
                    ...
                    { new Guid("f7cd8c2a-ab7f-42a4-3386-08da716a5c08"), "Name", new DateTime(2022, 7, 29, 0, 0, 0, 0, DateTimeKind.Unspecified), "Name", "String", "varchar(255)", "班级名称", "班级名称", false, true, false, new DateTime(2022, 7, 29, 22, 9, 7, 0, DateTimeKind.Unspecified), new Guid("181eef0c-8d00-4b6c-a3dd-59761cdb88d7"), null, 213 },
                    ...
                    { new Guid("fe287d7a-67c7-4ed2-33a3-08da716a5c08"), "LastModificationTime", new DateTime(2022, 7, 29, 0, 0, 0, 0, DateTimeKind.Unspecified), "LastModificationTime", "DateTime", "datetime2", "", "更新时间", false, true, false, new DateTime(2022, 7, 29, 22, 11, 14, 0, DateTimeKind.Unspecified), new Guid("a896fe8b-b3e1-4227-95b4-defc56ceb98b"), null, 220 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("d09bf250-c5b0-41cb-237d-08da00442990"), new DateTime(2022, 3, 7, 22, 9, 58, 0, DateTimeKind.Unspecified), new DateTime(2022, 7, 6, 21, 53, 17, 0, DateTimeKind.Unspecified), 5, new Guid("40ff1844-c099-4061-98e0-cd6e544fcfd3") }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, "news_type_nv", new DateTime(2021, 7, 25, 22, 40, 47, 0, DateTimeKind.Unspecified), new DateTime(2022, 7, 6, 21, 55, 30, 0, DateTimeKind.Unspecified), "女", 1, 2, "2" },
                    { 4, "3", new DateTime(2022, 6, 29, 20, 55, 46, 0, DateTimeKind.Unspecified), new DateTime(2022, 6, 29, 20, 55, 46, 0, DateTimeKind.Unspecified), "未知", 1, 0, "3" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("b6fd5425-504a-46a9-993b-2f8dc9158eb8"), "Print", new DateTime(2022, 6, 16, 17, 28, 0, 0, DateTimeKind.Unspecified), new DateTime(2021, 4, 18, 22, 8, 6, 0, DateTimeKind.Unspecified), "打印", 80, "Print" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 37, true, "classIndex", new DateTime(2022, 7, 29, 22, 5, 23, 0, DateTimeKind.Unspecified), "ContactsFilled", null, true, new DateTime(2022, 7, 29, 22, 35, 8, 0, DateTimeKind.Unspecified), "12.37", "班级管理", 20, 12, "/class", true, true, 2, "views/my/class/Index.vue" },
                    { 38, true, "studentIndex", new DateTime(2022, 7, 29, 22, 13, 33, 0, DateTimeKind.Unspecified), "AndroidFilled", null, true, new DateTime(2022, 7, 29, 22, 16, 34, 0, DateTimeKind.Unspecified), "12.38", "学生管理", 30, 12, "/student", true, true, 2, "views/my/student/Index.vue" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("01d95cc7-bc8c-4735-b331-08da716b6134"), new DateTime(2022, 7, 29, 22, 16, 34, 0, DateTimeKind.Unspecified), "Save", "保存", new DateTime(2022, 7, 29, 22, 16, 34, 0, DateTimeKind.Unspecified), 38, 50, "Save" },
                    ...
                    { new Guid("09b50a32-5748-408c-b32e-08da716b6134"), new DateTime(2022, 7, 29, 22, 16, 34, 0, DateTimeKind.Unspecified), "Insert", "添加", new DateTime(2022, 7, 29, 22, 16, 34, 0, DateTimeKind.Unspecified), 38, 20, "Insert" },
                    ...
                    { new Guid("25774728-1c9a-476a-b329-08da716b6134"), new DateTime(2022, 7, 29, 22, 35, 8, 0, DateTimeKind.Unspecified), "Save", "保存", new DateTime(2022, 7, 29, 22, 35, 8, 0, DateTimeKind.Unspecified), 37, 50, "Save" },
                    { new Guid("299c81a3-66a6-4ff2-b32f-08da716b6134"), new DateTime(2022, 7, 29, 22, 16, 34, 0, DateTimeKind.Unspecified), "Update", "修改", new DateTime(2022, 7, 29, 22, 16, 34, 0, DateTimeKind.Unspecified), 38, 30, "Update" },
                    ...
                    { new Guid("377b961c-3dee-445a-b328-08da716b6134"), new DateTime(2022, 7, 29, 22, 35, 8, 0, DateTimeKind.Unspecified), "Delete", "删除", new DateTime(2022, 7, 29, 22, 35, 8, 0, DateTimeKind.Unspecified), 37, 40, "Delete" },
                    ...
                    { new Guid("38f4d17c-d4a1-44f3-b334-08da716b6134"), new DateTime(2022, 7, 29, 22, 16, 34, 0, DateTimeKind.Unspecified), "Print", "打印", new DateTime(2022, 7, 29, 22, 16, 34, 0, DateTimeKind.Unspecified), 38, 80, "Print" },
                    ...
                    { new Guid("628c6e8c-3fc6-4dd0-b327-08da716b6134"), new DateTime(2022, 7, 29, 22, 35, 8, 0, DateTimeKind.Unspecified), "Update", "修改", new DateTime(2022, 7, 29, 22, 35, 8, 0, DateTimeKind.Unspecified), 37, 30, "Update" },
                    ...
                    { new Guid("7890cc93-ded0-4c18-b325-08da716b6134"), new DateTime(2022, 7, 29, 22, 35, 8, 0, DateTimeKind.Unspecified), "Display", "显示", new DateTime(2022, 7, 29, 22, 35, 8, 0, DateTimeKind.Unspecified), 37, 10, "Display" },
                    ...
                    { new Guid("8d82d688-77dd-4ca6-b326-08da716b6134"), new DateTime(2022, 7, 29, 22, 35, 8, 0, DateTimeKind.Unspecified), "Insert", "添加", new DateTime(2022, 7, 29, 22, 35, 8, 0, DateTimeKind.Unspecified), 37, 20, "Insert" },
                    ...
                    { new Guid("a63be630-ac04-40aa-b32a-08da716b6134"), new DateTime(2022, 7, 29, 22, 35, 8, 0, DateTimeKind.Unspecified), "Search", "检索", new DateTime(2022, 7, 29, 22, 35, 8, 0, DateTimeKind.Unspecified), 37, 60, "Search" },
                    ...
                    { new Guid("b3847204-1afa-4f58-b330-08da716b6134"), new DateTime(2022, 7, 29, 22, 16, 34, 0, DateTimeKind.Unspecified), "Delete", "删除", new DateTime(2022, 7, 29, 22, 16, 34, 0, DateTimeKind.Unspecified), 38, 40, "Delete" },
                    ...
                    { new Guid("bfc1476c-db0d-4db4-b32b-08da716b6134"), new DateTime(2022, 7, 29, 22, 35, 8, 0, DateTimeKind.Unspecified), "Export", "导出", new DateTime(2022, 7, 29, 22, 35, 8, 0, DateTimeKind.Unspecified), 37, 70, "Export" },
                    ...
                    { new Guid("ddd08d34-55a2-43eb-b32d-08da716b6134"), new DateTime(2022, 7, 29, 22, 16, 34, 0, DateTimeKind.Unspecified), "Display", "显示", new DateTime(2022, 7, 29, 22, 16, 34, 0, DateTimeKind.Unspecified), 38, 10, "Display" },
                    ...
                    { new Guid("f8c7ee2c-842e-402e-b32c-08da716b6134"), new DateTime(2022, 7, 29, 22, 35, 8, 0, DateTimeKind.Unspecified), "Print", "打印", new DateTime(2022, 7, 29, 22, 35, 8, 0, DateTimeKind.Unspecified), 37, 80, "Print" },
                    { new Guid("fc75b3a0-2a84-48f2-b332-08da716b6134"), new DateTime(2022, 7, 29, 22, 16, 34, 0, DateTimeKind.Unspecified), "Search", "检索", new DateTime(2022, 7, 29, 22, 16, 34, 0, DateTimeKind.Unspecified), 38, 60, "Search" },
                    { new Guid("fccd54ab-9e7d-4184-b333-08da716b6134"), new DateTime(2022, 7, 29, 22, 16, 34, 0, DateTimeKind.Unspecified), "Export", "导出", new DateTime(2022, 7, 29, 22, 16, 34, 0, DateTimeKind.Unspecified), 38, 70, "Export" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("28d17daa-b64e-4946-0369-08da5f56b13d"), new DateTime(2022, 7, 6, 21, 51, 57, 0, DateTimeKind.Unspecified), new DateTime(2022, 7, 6, 21, 51, 57, 0, DateTimeKind.Unspecified), new Guid("f64cfe50-1ef1-457f-0f20-08d9fdad00ab"), 3, new Guid("40ff1844-c099-4061-98e0-cd6e544fcfd3") },
                    { new Guid("31e97cae-1a79-4066-0368-08da5f56b13d"), new DateTime(2022, 7, 6, 21, 51, 57, 0, DateTimeKind.Unspecified), new DateTime(2022, 7, 6, 21, 51, 57, 0, DateTimeKind.Unspecified), new Guid("a7cd04db-bbe3-49b6-0f1e-08d9fdad00ab"), 2, new Guid("40ff1844-c099-4061-98e0-cd6e544fcfd3") },
                    { new Guid("390f485a-5f50-475b-0376-08da5f56b13d"), new DateTime(2022, 7, 6, 21, 51, 57, 0, DateTimeKind.Unspecified), new DateTime(2022, 7, 6, 21, 51, 57, 0, DateTimeKind.Unspecified), new Guid("b96f977c-a36e-4e7f-0f2d-08d9fdad00ab"), 13, new Guid("40ff1844-c099-4061-98e0-cd6e544fcfd3") },
                    { new Guid("3ce23bf9-f697-4d68-0372-08da5f56b13d"), new DateTime(2022, 7, 6, 21, 51, 57, 0, DateTimeKind.Unspecified), new DateTime(2022, 7, 6, 21, 51, 57, 0, DateTimeKind.Unspecified), new Guid("106fb69a-8bb5-4559-0f29-08d9fdad00ab"), 13, new Guid("40ff1844-c099-4061-98e0-cd6e544fcfd3") },
                    { new Guid("3d15457f-c009-44e4-036a-08da5f56b13d"), new DateTime(2022, 7, 6, 21, 51, 57, 0, DateTimeKind.Unspecified), new DateTime(2022, 7, 6, 21, 51, 57, 0, DateTimeKind.Unspecified), new Guid("a1ddd02f-8c21-4d79-0f21-08d9fdad00ab"), 5, new Guid("40ff1844-c099-4061-98e0-cd6e544fcfd3") },
                    { new Guid("4df2715f-2a1e-45c2-0375-08da5f56b13d"), new DateTime(2022, 7, 6, 21, 51, 57, 0, DateTimeKind.Unspecified), new DateTime(2022, 7, 6, 21, 51, 57, 0, DateTimeKind.Unspecified), new Guid("a3754771-f6e9-4a23-0f2c-08d9fdad00ab"), 13, new Guid("40ff1844-c099-4061-98e0-cd6e544fcfd3") },
                    { new Guid("509ad581-1589-41a3-0379-08da5f56b13d"), new DateTime(2022, 7, 6, 21, 51, 57, 0, DateTimeKind.Unspecified), new DateTime(2022, 7, 6, 21, 51, 57, 0, DateTimeKind.Unspecified), new Guid("c77c812a-1601-4311-0f70-08d9fdad00ab"), 19, new Guid("40ff1844-c099-4061-98e0-cd6e544fcfd3") },
                    { new Guid("653ffa0a-9a3f-447a-036b-08da5f56b13d"), new DateTime(2022, 7, 6, 21, 51, 57, 0, DateTimeKind.Unspecified), new DateTime(2022, 7, 6, 21, 51, 57, 0, DateTimeKind.Unspecified), new Guid("1cb6fbe1-4a6c-4aad-0f22-08d9fdad00ab"), 6, new Guid("40ff1844-c099-4061-98e0-cd6e544fcfd3") },
                    { new Guid("6c20dd18-622a-4c81-036c-08da5f56b13d"), new DateTime(2022, 7, 6, 21, 51, 57, 0, DateTimeKind.Unspecified), new DateTime(2022, 7, 6, 21, 51, 57, 0, DateTimeKind.Unspecified), new Guid("d2e6ea60-2cf6-478a-0f23-08d9fdad00ab"), 8, new Guid("40ff1844-c099-4061-98e0-cd6e544fcfd3") },
                    { new Guid("95e2ad9f-f876-4881-0371-08da5f56b13d"), new DateTime(2022, 7, 6, 21, 51, 57, 0, DateTimeKind.Unspecified), new DateTime(2022, 7, 6, 21, 51, 57, 0, DateTimeKind.Unspecified), new Guid("b5881044-afb8-40b2-0f28-08d9fdad00ab"), 13, new Guid("40ff1844-c099-4061-98e0-cd6e544fcfd3") },
                    { new Guid("9cdb59fa-4c72-4adf-0373-08da5f56b13d"), new DateTime(2022, 7, 6, 21, 51, 57, 0, DateTimeKind.Unspecified), new DateTime(2022, 7, 6, 21, 51, 57, 0, DateTimeKind.Unspecified), new Guid("f4621fbe-6b40-4454-0f2a-08d9fdad00ab"), 13, new Guid("40ff1844-c099-4061-98e0-cd6e544fcfd3") },
                    { new Guid("a10fdd9a-93df-47d6-0377-08da5f56b13d"), new DateTime(2022, 7, 6, 21, 51, 57, 0, DateTimeKind.Unspecified), new DateTime(2022, 7, 6, 21, 51, 57, 0, DateTimeKind.Unspecified), new Guid("541d9045-47b2-4629-0f2e-08d9fdad00ab"), 13, new Guid("40ff1844-c099-4061-98e0-cd6e544fcfd3") },
                    { new Guid("aa9a9ba6-a5cf-4620-037b-08da5f56b13d"), new DateTime(2022, 7, 6, 21, 51, 57, 0, DateTimeKind.Unspecified), new DateTime(2022, 7, 6, 21, 51, 57, 0, DateTimeKind.Unspecified), new Guid("6c09c0c0-72fa-4842-0f1f-08d9fdad00ab"), 32, new Guid("40ff1844-c099-4061-98e0-cd6e544fcfd3") },
                    { new Guid("b414e6e7-ab37-48ab-0378-08da5f56b13d"), new DateTime(2022, 7, 6, 21, 51, 57, 0, DateTimeKind.Unspecified), new DateTime(2022, 7, 6, 21, 51, 57, 0, DateTimeKind.Unspecified), new Guid("13f3f74d-c6fc-4488-0f2f-08d9fdad00ab"), 15, new Guid("40ff1844-c099-4061-98e0-cd6e544fcfd3") },
                    { new Guid("bc7ad808-e114-47ae-037a-08da5f56b13d"), new DateTime(2022, 7, 6, 21, 51, 57, 0, DateTimeKind.Unspecified), new DateTime(2022, 7, 6, 21, 51, 57, 0, DateTimeKind.Unspecified), new Guid("3f6d0af7-5386-4d3a-0f71-08d9fdad00ab"), 28, new Guid("40ff1844-c099-4061-98e0-cd6e544fcfd3") },
                    { new Guid("cd8357e8-e0b8-4a44-036f-08da5f56b13d"), new DateTime(2022, 7, 6, 21, 51, 57, 0, DateTimeKind.Unspecified), new DateTime(2022, 7, 6, 21, 51, 57, 0, DateTimeKind.Unspecified), new Guid("3bc0e68f-d03d-4e99-0f26-08d9fdad00ab"), 11, new Guid("40ff1844-c099-4061-98e0-cd6e544fcfd3") },
                    { new Guid("cf58224e-9d8a-4dd7-036e-08da5f56b13d"), new DateTime(2022, 7, 6, 21, 51, 57, 0, DateTimeKind.Unspecified), new DateTime(2022, 7, 6, 21, 51, 57, 0, DateTimeKind.Unspecified), new Guid("ec535908-8671-4928-0f25-08d9fdad00ab"), 10, new Guid("40ff1844-c099-4061-98e0-cd6e544fcfd3") },
                    { new Guid("d11fb2b1-54d2-4151-0374-08da5f56b13d"), new DateTime(2022, 7, 6, 21, 51, 57, 0, DateTimeKind.Unspecified), new DateTime(2022, 7, 6, 21, 51, 57, 0, DateTimeKind.Unspecified), new Guid("523b53b5-8159-4a16-0f2b-08d9fdad00ab"), 13, new Guid("40ff1844-c099-4061-98e0-cd6e544fcfd3") },
                    { new Guid("ef9cbb6d-70f0-4246-036d-08da5f56b13d"), new DateTime(2022, 7, 6, 21, 51, 57, 0, DateTimeKind.Unspecified), new DateTime(2022, 7, 6, 21, 51, 57, 0, DateTimeKind.Unspecified), new Guid("b7533a90-dae4-4263-0f24-08d9fdad00ab"), 9, new Guid("40ff1844-c099-4061-98e0-cd6e544fcfd3") },
                    { new Guid("f90cd8a1-2fae-40ed-0370-08da5f56b13d"), new DateTime(2022, 7, 6, 21, 51, 57, 0, DateTimeKind.Unspecified), new DateTime(2022, 7, 6, 21, 51, 57, 0, DateTimeKind.Unspecified), new Guid("eb958545-6449-40db-0f27-08d9fdad00ab"), 13, new Guid("40ff1844-c099-4061-98e0-cd6e544fcfd3") }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("b669ec48-aa60-441a-b59d-7f9be7b94155"), new DateTime(2022, 7, 6, 21, 49, 13, 0, DateTimeKind.Unspecified), new DateTime(2022, 7, 6, 21, 49, 13, 0, DateTimeKind.Unspecified), new Guid("f0bd38c2-f1de-4bd9-e2db-08da00a93622"), new Guid("1550d6d4-0529-4fdd-62dc-08da00e3d8a0") },
                    ...
                    { new Guid("da9b04c9-d1ef-4721-8a94-4558dfe2eb7d"), new DateTime(2022, 6, 21, 19, 59, 2, 0, DateTimeKind.Unspecified), new DateTime(2022, 6, 21, 19, 59, 2, 0, DateTimeKind.Unspecified), new Guid("f0bd38c2-f1de-4bd9-e2db-08da00a93622"), new Guid("a1b6dafb-2b6a-4ff9-62da-08da00e3d8a0") },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("23d32064-6eb8-4ea9-9b2a-7e2f09f53e4d"), new DateTime(2022, 7, 6, 21, 49, 13, 0, DateTimeKind.Unspecified), new DateTime(2022, 7, 6, 21, 49, 13, 0, DateTimeKind.Unspecified), new Guid("40ff1844-c099-4061-98e0-cd6e544fcfd3"), new Guid("1550d6d4-0529-4fdd-62dc-08da00e3d8a0") },
                    ...
                    { new Guid("9b7bee51-2fb4-4aba-b680-6eea512919eb"), new DateTime(2022, 6, 21, 19, 59, 2, 0, DateTimeKind.Unspecified), new DateTime(2022, 6, 21, 19, 59, 2, 0, DateTimeKind.Unspecified), new Guid("40ff1844-c099-4061-98e0-cd6e544fcfd3"), new Guid("a1b6dafb-2b6a-4ff9-62da-08da00e3d8a0") },
