    ...
    public partial class SqlServer_init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0a8bdb18-758a-4798-9ffc-e7031dcbf262"), new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "岗位", "SysPost", new DateTime(2022, 5, 24, 21, 57, 34, 0, DateTimeKind.Unspecified), null, "dbo", "sys_post", "TABLE" },
                    ...
                    { new Guid("2ae9e532-7d9a-474b-b629-50a39945c44d"), new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "菜单功能", "SysMenuFunction", new DateTime(2022, 5, 24, 21, 57, 34, 0, DateTimeKind.Unspecified), null, "dbo", "sys_menu_function", "TABLE" },
                    { new Guid("3da5d264-2e8d-460c-a10c-ff9a6bb57a60"), new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "用户与角色", "SysUserRole", new DateTime(2022, 5, 24, 21, 57, 34, 0, DateTimeKind.Unspecified), null, "dbo", "sys_user_role", "TABLE" },
                    { new Guid("524e71b4-cbf7-4248-8b29-3f99b43f2eb2"), new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "自定义数据权限", "SysDataAuthorityCustom", new DateTime(2022, 5, 24, 21, 57, 34, 0, DateTimeKind.Unspecified), null, "dbo", "sys_data_authority_custom", "TABLE" },
                    { new Guid("60cceba1-28bf-4d1d-b603-4edf95d512b8"), new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "操作日志", "SysOperationLog", new DateTime(2022, 5, 24, 21, 57, 34, 0, DateTimeKind.Unspecified), null, "dbo", "sys_operation_log", "TABLE" },
                    { new Guid("6323638b-a45f-4a76-886e-69a9e9be0901"), new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "用户", "SysUser", new DateTime(2022, 5, 24, 21, 57, 34, 0, DateTimeKind.Unspecified), null, "dbo", "sys_user", "TABLE" },
                    { new Guid("651bb982-1130-4e1c-9070-36b90dcf2324"), new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "工作流审批步骤配置", "FlowApprovalStep", new DateTime(2022, 5, 24, 21, 57, 34, 0, DateTimeKind.Unspecified), null, "dbo", "flow_approval_step", "TABLE" },
                    { new Guid("69b24f04-0ed3-45fc-91d9-0dc929175a57"), new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "用户与岗位", "SysUserPost", new DateTime(2022, 5, 24, 21, 57, 34, 0, DateTimeKind.Unspecified), null, "dbo", "sys_user_post", "TABLE" },
                    { new Guid("69edd8a8-1d24-478c-a909-b82039edcec0"), new DateTime(2022, 5, 23, 0, 0, 0, 0, DateTimeKind.Unspecified), "低代码检索表", "LowCodeSearch", new DateTime(2022, 5, 24, 21, 57, 34, 0, DateTimeKind.Unspecified), null, "dbo", "low_code_search", "TABLE" },
                    { new Guid("6ba9805c-916e-4d2c-99d0-216fcbc361cc"), new DateTime(2022, 5, 23, 0, 0, 0, 0, DateTimeKind.Unspecified), "低代码表", "LowCodeTable", new DateTime(2022, 5, 24, 21, 57, 34, 0, DateTimeKind.Unspecified), null, "dbo", "low_code_table", "TABLE" },
                    { new Guid("6fabc67a-8b48-49a6-8ba1-c8a32c499d36"), new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "功能", "SysFunction", new DateTime(2022, 5, 24, 21, 57, 34, 0, DateTimeKind.Unspecified), null, "dbo", "sys_function", "TABLE" },
                    ...
                    { new Guid("79fbd4ec-9f4e-45dc-8065-70f2eb422cdf"), new DateTime(2022, 5, 23, 0, 0, 0, 0, DateTimeKind.Unspecified), "低代码表信息", "LowCodeTableInfo", new DateTime(2022, 5, 24, 21, 57, 34, 0, DateTimeKind.Unspecified), null, "dbo", "low_code_table_info", "TABLE" },
                    { new Guid("7ad3b915-f0bd-443a-89cd-42d41dd6c554"), new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "工作流用户审批步骤", "FlowApprovalStepUser", new DateTime(2022, 5, 24, 21, 57, 34, 0, DateTimeKind.Unspecified), null, "dbo", "flow_approval_step_user", "TABLE" },
                    { new Guid("852f53ff-0d00-4c32-aa55-a9c11993751b"), new DateTime(2022, 5, 23, 0, 0, 0, 0, DateTimeKind.Unspecified), "低代码列表", "LowCodeList", new DateTime(2022, 5, 24, 21, 57, 34, 0, DateTimeKind.Unspecified), null, "dbo", "low_code_list", "TABLE" },
                    { new Guid("8da38d20-8a09-4e81-8dd8-ed6702aee380"), new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "角色菜单功能关联", "SysRoleMenuFunction", new DateTime(2022, 5, 24, 21, 57, 34, 0, DateTimeKind.Unspecified), null, "dbo", "sys_role_menu_function", "TABLE" },
                    { new Guid("ae6d94d8-6a15-4348-b600-aa17e4b61718"), new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "工作流节点", "FlowNode", new DateTime(2022, 5, 24, 21, 57, 34, 0, DateTimeKind.Unspecified), null, "dbo", "flow_node", "TABLE" },
                    { new Guid("af37f705-7ba0-4883-b1be-8a274ea4c026"), new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "数据字典", "SysDictionary", new DateTime(2022, 5, 24, 21, 57, 34, 0, DateTimeKind.Unspecified), null, "dbo", "sys_dictionary", "TABLE" },
                    { new Guid("d2600250-6f32-4d7d-8395-96cc9fa36db4"), new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "菜单", "SysMenu", new DateTime(2022, 5, 24, 21, 57, 34, 0, DateTimeKind.Unspecified), null, "dbo", "sys_menu", "TABLE" },
                    { new Guid("d26d07cb-158a-4cb2-8b20-5dfd5181af54"), new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "组织", "SysOrganization", new DateTime(2022, 5, 24, 21, 57, 34, 0, DateTimeKind.Unspecified), null, "dbo", "sys_organization", "TABLE" },
                    { new Guid("d8948c56-c5bd-4061-b272-5417375f38f0"), new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "审批流审批", "FlowApproval", new DateTime(2022, 5, 24, 21, 57, 34, 0, DateTimeKind.Unspecified), null, "dbo", "flow_approval", "TABLE" },
                    { new Guid("e79db53b-7162-4669-9b5e-f860501475ac"), new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "数据权限", "SysDataAuthority", new DateTime(2022, 5, 24, 21, 57, 34, 0, DateTimeKind.Unspecified), null, "dbo", "sys_data_authority", "TABLE" },
                    { new Guid("f3d7bbb3-c1fb-4d61-92a4-9bc101811335"), new DateTime(2022, 4, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "角色", "SysRole", new DateTime(2022, 5, 24, 21, 57, 34, 0, DateTimeKind.Unspecified), null, "dbo", "sys_role", "TABLE" }
                });
